 ...
 */
public class SkierConnectionManager {
	...
	private final String hostName = "cs6650.cgnn0uvungni.us-east-1.rds.amazonaws.com";


//	// User to connect to your database instance. By default, this is "root2".
//	private final String user = "root";
//	// Password for the user.
//	private final String password = "offerduoduo";
//	// URI to your database server. If running on the same machine, then this is "localhost".
//	private final String hostName = "localhost";
	...
	private final String schema = "Skier";
		...
		if (connection == null) {
			try {
				...
				connection = DriverManager.getConnection(
						"jdbc:mysql://" + this.hostName + ":" + this.port + "/" + schema + "?useSSL=false",
